...
<br><h2 id = "9.2">9.2. Classificação dos produtos farmacêuticos</h2>
    ...
    <p><span class = "bold">2. Quanto ao uso terapêutico</span>, exemplos:</p>
    <ul>
        <li>Tranquilizante</li>
        <li>Anticoncepcional</li>
        <li>Sedativo</li>
        <li>Analgésico</li>
    ...
    <p><span class = "bold">3. Quanto à conversão química envolvidas em sua produção</span>, exemplos:</p>
    <ul>
        <li>Alquilação</li>
        <li>Halogenação</li>
        <li>Extração</li>
    ...
    <p>No entanto, para produção individual em larga, a classificação pela conversão química é a mais empregada e, portanto, será a única focada neste capítulo. </p>

<br><h2 id = "9.3">9.3. Processos de conversão química</h2>
    ...
    <h3></h3>
        ...
        <div class = "box"><p><span class = "bold">1. O-alquilação:</span> substituição de um hidrogênio em um grupo hidroxi de álcoois ou fenóis;</p>
        <p><span class = "bold">2. N-alquilação: </span>substituição de um hidrogênio ligado a um átomo de nitrogênio;</p>
        <p><span class = "bold">3. C-alquilação: </span>substituição de um hidrogênio em hidrocarbonetos.</p></div>
    ...
    <h3>Condensação</h3>
        ...
        <p>O produto da reação de condensação é adicionado ainda aquecido em água fervente e posteriormente fervido. Em seguida o condensado é dissolvido em soda cáustica (NaOH) quente diluída e precipitado com ácido acético (H3COOH). Por fim, ele é purificado por cristalização a partir de um álcool e filtrado com carvão ativo. </p>
        <br><h3>Desidratação</h3>
        <p>A reação de desidratação é um tipo especial de condensação onde, durante a combinação de duas moléculas se descartada uma ou mais molécula de água (H2O). </p>
...
<br><h2 id = "9.4">9.4. Construindo e fixando o conhecimento</h2>
...
<br><h2 id = "9-ref">Referências Bibliográficas</h2>
