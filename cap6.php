...
<div class="atv">
    ...
    <p>Faça um levantamento histórico de pelo menos três produtos de fontes petroquímicas que sejam classificados como especialidades.</p>
</div>
...
<div class="atv">
    ...
    <p>Na FISPQ (Ficha de Segurança de Produto Químico) dos componentes do BTX estes produtos são classificados como carcinogênicos e mutagênicos. Responda: </p>
...
<p>Com relação ao uso os polímeros podem ser classificados em <span class="bold">polímeros de uso geral</span> e <span class="bold">polímeros de engenharia</span>. Os polímeros de uso geral são os polímeros usados nas mais variadas aplicações, tais como o polietileno, o polipropileno, o poliestireno, o poli(metacrilato de metila), o poli(cloreto de vinila), baquelite, entre outros. Já os polímeros de engenharia são empregados na substituição de materiais clássicos usados na engenharia, como madeira e metais. São exemplos de polímeros de engenharia o poliacetal, o policarbonato e poli(tetrafluor-etileno).</p>
<p>Com relação à taticidade os polímeros são classificados em <span class="bold">isotáticos</span>, quando os grupos funcionais estão todos encadeados no mesmo lado da molécula, <span class="bold">sindiotáticos</span>, quando os grupos funcionais estão encadeados de forma alternada nos lados da molécula e <span class="bold">atáticos</span>, quando os grupos funcionais estão encadeados de forma aleatória nos lados da molécula.</p>
<p>Os polímeros podem ser obtidos por diferentes técnicas de polimerização, que não são ligadas a nenhum tipo de polímero específico. A reação de polimerização pode ser conduzida pela técnica de <span class="bold">polimerização em massa</span>, <span class="bold">polimerização em solução</span>, <span class="bold">polimerização em suspensão</span>, <span class="bold">polimerização em emulsão e polimerização interfacial</span>. A polimerização em massa consiste na reação de polimerização na qual o meio reacional é composto apenas de monômero e iniciador. </p>
<p>Já na polimerização em solução além do monômero e do iniciador há também um solvente solubilizando-os. Quando o polímero formado é também solúvel no solvente usado, ao final da polimerização deve-se precipitar o polímero empregando-se grandes quantidades de um não-solvente. Quando o polímero formado é insolúvel no solvente usado não há a necessidade de se usar um não-solvente, esta técnica em particular recebe o nome de <span class="bold">polimerização em lama</span>. O polímero obtido pode ser separado por filtração.</p>
...
<div class="atv">
    ...
    <p>Explique a diferença entre a polimerização em suspensão da polimerização em emulsão.</p>
</div>
...
<p><span class="bold">3. </span>Por que a substância eteno e não a substância propeno é a principal matéria-prima da indústria petroquímica se ambos os gases podem sofrer os mesmos tipo de reação química?</p>
<p><span class="bold">4. </span>Quais os principais produtos obtidos a partir do gás de síntese? Qual a importância destes produtos na indústria petroquímica?</p>
<p><span class="bold">5. </span>O que são detergentes? Qual sua principal característica?</p>
<p><span class="bold">6. </span>Como são classificados os fertilizantes? Quais são produzidos pela indústria petroquímica?</p>
<p><span class="bold">7. </span>Defina: polímero e monômero?</p>
<p><span class="bold">8. </span>Qual a diferença entre polímeros de adição e polímeros de condensação?</p>
