...
<h2 id = "7.1">7.1. Uma breve introdução sobre a indústria de celulose e papel</h2>
    ...
    <caption>* O Brasil é o 10º produtor de papel do mundo com uma produção de 9.844 mil toneladas. <br> Fonte: Bracelpa e RISI.</caption>
    ...
    <caption>* mil hectares.<br>Fonte: FAO/STCP/SAE; Bracelpa.</caption>
    ...
    <!--FIGURA 7.1 -->
    <figure>
        <img src = "img/figura-7-1.jpg" alt = "audiodescrição">
    ...
    <caption>* Dados de 2011 não estão finalizados.<br>Fonte: Secex (Secretária de Comércio Exterior)</p>
    ...
    <!-- FIGURA 7.2 -->
    <figure>
        <img src = "img/figura-7-2.jpg" alt = "audiodescrição">
    ...
    <caption>Fonte: Bracelpa</caption>
    ...
    <!-- FIGURA 7.3 -->
    <figure>
        <img src = "img/figura-7-3.jpg" alt = "audiodescrição">
    ...
    <!-- figura 7.4 -->
    <figure>
        <img src = "img/figura-7-4.jpg" alt = "audiodescrição">
...
<br><h2 id = "7.2">7.2. Fabricação da polpa e papel</h2>
...
<!-- FIGURA 7.5 -->
<figure>
    <img src = "img/figura-7-5.jpg" alt = "audiodescrição">
...
<!-- FIGURA 7.6 -->
<figure>
    <img src = "img/figura-7-6.jpg" alt = "audiodescrição">
...
<h3>Matéria-prima</h3>
    <ul>
        ...
        <li> Alvejamento: antigamente - bissulfeto de sódio ou cálcio; recentemente - ozônio; oxigênio, H2O2, dióxido de cloro; </li>
    ...
    <div class = "box"><p>Branqueamento é o processo químico aplicado às polpas celulósicas para aumentar suas alvuras. A celulose e as polioses não contribuem na coloração das polpas, pois são naturalmente brancas. Contudo, a lignina, sujeira, feixes de fibras e rejeitos contribuem na cor escura.</p></div>
    ...
    <table>
        ...
        <tr>
            ...
            <td>Reação com Ca(HSO3)2</td>
            <td>Sulfonação das ligninas e hidrólise das hemiceluloses</td>
        </tr>
        <tr>
            <td>Solução a 12,5% de NaOH, Na2S e Na2CO3</td>
            <td>7% em massa de SO2, 4,5% de ácido sulfuroso e 2,5% Ca(HSO3)2</td>
            <td>Solução tamponada de Na2S (100-200 g/L) com Na2CO3</td>
        </tr>
        <tr>
    ...
    <caption>Fonte: Shreve and Brink (1997).</caption>
...
<br><h2 id = "7.3">7.3. Construindo e fixando o conhecimento</h2>
...
<br><h2 id = "7-ref">Referências Bibliográficas</h2>
