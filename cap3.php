...
<h2 id = "3.1">3.1. Indústria cerâmica</h2>
    ...
    <h3>3.1.2.  Principais matérias-primas</h3>
        ...
        <p>O feldspato é o principal fundente empregado nas formulações cerâmicas. Ele pode estar presente na argila da jazida, ou pode ser adicionado conforme a necessidade. Os três tipo mais comuns de feldspatos usados na produção de produtos cerâmicos são os potássicos (K2O•Al2O3•6SiO2), os sódicos (Na<sub>2</sub>O•Al<sub>2</sub>O<sub>3</sub>•6SiO<sub>2</sub>) e os cálcicos (CaO•Al<sub>2</sub>O<sub>3</sub>•6SiO<sub>2</sub>). A seguir, tem-se a reação química de formação da caulinita a partir de um feldspato potássico:</p>
        <!-- ESTEQUIOMETRIA 3.1 SERÁ IMAGEM OU CÓDIGO? -->
        <p>Por fim, o terceiro constituinte principal dos produtos cerâmicos é a areia ou sílica (SiO<sub>2</sub>). Segundo a NBR 7211/83, a areia divide-se, granulometricamente, em:</p>
        <ul class = "indentacao">
            <li> Areia muito fina (entre 0,15 mm e 0,6 mm);</li>
            <li> Areia fina (entre 0,6 mm e 1,2 mm);</li>
            <li> Areia média (entre 1,2 mm e 2,4 mm);</li>
            <li> Areia grossa (entre 2,4 mm e 4,8 mm).</li>
        </ul>
        <div class = "box"><p>Para os produtos cerâmicos de cor clara, é preciso usar areia com baixo teor de ferro.</p></div>
        <p>Além dos três minerais descritos anteriormente, diversos outros componentes são usados na produção de cerâmicas, tais como: os fundentes - bórax (Na<sub>2</sub>B<sub>4</sub>O<sub>7</sub>•10H<sub>2</sub>O); barrilha (Na<sub>2</sub>CO</sub>3); fluorita (CaF<sub>2</sub>); oxido de chumbo; oxido de ferro; dentre outros e os refratários - alumina (Al<sub>2</sub>O<sub>3</sub>); magnesita (MgCO<sub>3</sub>); calcário (CaCO<sub>3</sub>); dolomita (CaMg(CO<sub>3</sub>)<sub>2</sub>); dentre outros.</p>
    ...
    <h3>3.1.3. Processos de conversão química</h3>
        ...
        <div class = "indentacao">
            ...
            <br><span class = "bold">IV. </span>Formação de silicatos (> 900 ºC);</p>
        </div>
        <p>Para exemplificar essas conversões as principais reações químicas que ocorrem durante o aquecimento da caulinita (que é uma das argilas mais usada na produção de materiais cerâmicos) é mostrado na eq. 3.2. </p>
        ...
        <p>A fase de vitrificação é muito importante no processo de produção de materiais cerâmicos, uma vez que atua como ligante na porcelana e atribui-lhe transparência. Contudo, uma vitrificação muito intensa destrói a qualidade dos refratários. </p>
        <p>A partir do grau de vitrificação, ou a progressiva redução da porosidade, é possível classificar os produtos cerâmicos conforme a seguinte lista:</p>
        <ul class = "indentacao">
            <li> Diversos graus de vitrificação: cerâmicas brancas;</li>
            <li> Pouca vitrificação: produtos estruturais de cerâmica, também conhecidos como cerâmica vermelha e refratários;</li>
...
<h2 id = "3.2">3.2. Indústria de cimento</h2>
    ...
    <h3>3.2.2.  Processos de produção do cimento </h3>
        ...
        <p>A extração é feita, habitualmente por meio de explosões para obter-se blocos com dimensão inferior a 0,5 m3. A matéria extraída é reduzida em britadores de martelos conforme mostra a Figura 3.1, com o propósito de se obter material cuja dimensão seja inferior a 9 cm. Ao mesmo tempo em que se efetua a redução, é feita a correção da mistura para que se aproxime da composição química desejada.</p>
        <!-- FIGURA 3.1 -->
        <figure>
        ...
        <p>Uma vez cozido, o clínquer sai do forno indo para o arrefecedor onde sofre uma diminuição brusca de temperatura que lhe confere características importantes do cimento. Como consequência macroscópica, o clínquer toma tons acinzentados. </p>
        <p>O arrefecedor forma com o forno um conjunto interdependente no processo de clinquerização com vista à obtenção de uma maior produtividade e qualidade do produto. Assim, se por um lado o arrefecedor tem de conseguir uma temperatura baixa no clínquer imediatamente depois da sua saída do forno, por outro, o forno tem de garantir uma descarga de clínquer uniforme, um clínquer com distribuição granulométrica uniforme e uma temperatura constante na zona de cozedura.</p>
        <p>A moagem do clínquer é a fase final do processo de produção do cimento. Simultaneamente com a moagem, são introduzidos aditivos e gesso que irão dar as características ao cimento que não foram introduzidas durante os processos anteriores. Conforme as quantidades destes aditivos, formar-se-ão vários tipos de cimento com características próprias. Após a moagem, que é decisiva para a qualidade do produto, o cimento é armazenado para posterior expedição.</p>

    <h3>3.2.3. Principais conversões químicas da etapa de clinquerização</h3>
        <p>Basicamente, todas as conversões químicas envolvidas na produção do cimento, estão presentes na etapa de clinquerização, como podemos observar nas etapas apresentadas a seguir: </p>
        <p><span class = "bold">I. Evaporação da água livre:</span> ocorre no primeiro estágio de ciclones em temperaturas abaixo de 100 °C. </p>
        <div class = "box-centro"><p>H<sub>2</sub>O(l) → H<sub>2</sub>O(g)      539,6 cal g<sup>-1</sup></p></div>
        <br>

        <p><span class = "bold">II. Decomposição do carbonato de magnésio:</span> a decomposição da dolomita em MgO e CO<sub>2</sub> tem início em 340 °C, porém a medida que o teor de cálcio aumenta, também se eleva a temperatura de decomposição.</p>
        <div class = "box-centro"><p>MgCO<sub>3</sub>(s) → MgO(s) + CO<sub>2</sub>(g)     270 cal g<sub>-1</sub> </p></div>
        ...
        <div class = "box-centro"><p>CaCO<sub>3</sub>(s) → CaO + CO<sub>2</sub>(g)		 393 cal•g<sub>-1</sub>	</p></div>
        ...
        <p><span class = "bold">V. Formação do silicato dicálcico (2CaO • SiO<sub>2</sub>): </span>tem início em temperatura de 900 °C onde mesmo sílica livre e CaO já reagem lentamente. Na presença de ferro e alumínio esta reação química é acelerada.</p>
        <div class = "box-centro"><p>2CaO + SiO<sub>2</sub> → 2CaO •SiO<sub>2</sub></p></div>
        <br>

        <p><span class = "bold">VI. Formação do silicato tricálcico (3CaO • SiO<sub>2</sub>): </span>inicia sua formação entre 1200 °C e 1300 °C a 1400 °C os produtos de reação são 3CaO • SiO<sub>2</sub>, 2CaO • SiO<sub>2</sub>, 3CaO • Al<sub>2</sub>O<sub>3</sub> e 4CaO • Al<sub>2</sub>O<sub>3</sub> • Fe<sub>2</sub>O<sub>3</sub> e o restante de CaO não combinado.</p>
        <div class = "box-centro"><p>2CaO • SiO<sub>2</sub> + CaO → 3CaO • SiO<sub>2</sub></p></div>
        <br>

        <p><span class = "bold">VII. Primeiro resfriamento: </span>o primeiro resfriamento ocorre dentro do forno, após o clínquer passar pela zona de máxima temperatura. Nesta etapa pode ocorrer a decomposição do 3CaO • SiO<sub>2</sub> segundo a reação:</p>
        <div class = "box-centro"><p>3CaO • SiO<sub>2</sub> → 2CaO • SiO<sub>2</sub> + CaO </p></div>
        <div class = "box"><p>A complementação das reações de clinquerização pode ser afetada pelo resfriamento sofrido pelo clínquer. Um resfriamento lento leva a um cimento de baixa qualidade.</p></div>
        <br>

        <p><span class = "bold">VIII. Segundo resfriamento: </span>o segundo resfriamento ocorre abaixo de 1200 °C, já no resfriador. Este resfriamento lento também provoca uma maior corrosão dos cristais de 3CaO • SiO<sub>2</sub> pela penetração desta fase, nas bordas dos cristais, auxiliando a formação de 2CaO • SiO<sub>2</sub>. O magnésio não combinado terá sua cristalização nesta etapa. Quanto mais lento for o resfriamento, maior será o desenvolvimento dos cristais de MgO, aglutinando em zonas.</p>
        <br>
    ...
    <br><h2 id = "3.3">3.3. Construindo e fixando o conhecimento</h2>
...
<br><h2 id = "3-ref">Referências Bibliográficas</h2>
    ...
    <p>VAN VLACK, L. H. <strong>Propriedades dos materiais cerâmicos</strong>. 1a edição, Ed. Edgard Blücher LTDA., São Paulo, 1973, 318p.</p>
    <p>BUSTAMANTE, G. M.; BRESSIANI, J. C. <strong>A indústria cerâmica brasileira</strong>. Cerâmica Industrial. São Paulo, v. 5, n. 3, p. 31-36, maio, 2000. </p>
