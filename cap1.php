...
<ol class="indentacao">
  <li>Obtenção do dióxido de enxofre \((SO_2)\);</li>
...
<figure>
  ...
  <figcaption><span class="bold">Figura 1.3.</span> Fluxograma representativo da fabricação de \(H_2SO_4\) via processo de contato.</figcaption>
</figure>
...
<div class="box-centro">
  <p>\(S(s) + O_2 \rightleftharpoons SO_2(g)\)</p>
</div>
