...
<figure class="retrato lateral">
    <img src="img/fig-5-1.jpg" alt="audiodescrição" class="lightbox-img" tabindex="1">
...
<p>Os processos de hidrotratamento e hidrocraqueamento das refinarias de petróleo usam o gás hidrogênio em abundância, e algumas o produzem nas unidades de reforma catalítica. Contudo, a unidade de reforma catalítica não consegue produzir <span class="nobreak">H<sub>2</sub></span> em quantidades suficientes para atender as demandas do HDT e HCC. Por isso, em refinarias possuem unidades de HDT e HCC faz-se necessário a instalação de uma unidade de geração de hidrogênio, operando segundo reações de oxidação parcial das frações pesadas ou de reforma das frações leves com vapor d’água.</p>
...
<p><span class="bold">8. </span> Citar dois processos de conversão cujo objetivo se a produção de gasolina de alta octanagem.</p>
<p><span class="bold">9. </span> Qual a diferença entre processo de adoçamento e processo de dessulfurização?</p>
<p><span class="bold">10. </span> O H<sub>2</sub> é produzido na unidade de reforma catalítica e consumido nas unidades de HDT e HCC, então, explicar porque se justifica a instalação de uma unidade geradora de H<sub>2</sub>?</p>
