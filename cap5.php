...
<br><h2 id = "5-2">5.2. Petróleo</h2>
    <p>A palavra petróleo vem do latim e significa <em>petra</em> (pedra) e <em>oleum</em> (óleo), ou seja, óleo de pedra. O petróleo consiste de uma distribuição de moléculas com estruturas químicas e massas molares diferentes. Os principais componentes do petróleo são os hidrocarbonetos, ou seja, substâncias compostas apenas de carbono e hidrogênio. De acordo com a estrutura os hidrocarbonetos podem ser classificados em saturados ou parafinas, insaturados ou olefinas, aromáticos ou arenos. Os hidrocarbonetos parafínicos ainda podem ser divididos em normais ou n-parafinas, ramificados e cíclicos ou naftênicos. Contudo, outros elementos químicos podem aparecer na composição do petróleo, na forma de compostos orgânicos, os mais comuns são o oxigênio, o nitrogênio e o enxofre. Metais também podem ocorrer na forma de sais orgânicos. Os principais grupos de componentes do petróleo são os hidrocarbonetos saturados, hidrocarbonetos aromáticos, resinas e os asfaltenos, determinados através da análise de SARA (Saturados, Aromáticos, Resinas e Asfaltenos). Dentre estas frações os hidrocarbonetos saturados, parafinas, são os principais formadores de depósito, mas os asfaltenos e as resinas também podem formar deposição</p>
        ...
        <caption>Fonte: Szklo e Uller, 2008.</caption>
...
<br><h2 id = "5-3">5.3. Refino do petróleo</h2>
...
<br><h2 id = "5-4">5.4. Processos de separação</h2>
    <h3>5.4.1. Destilação</h3>
        ...
        <table>
            ...
            <tr>
                ...
                <td>< 40</td>
                <td>Composto principalmente por metano e etano (C<sub>1</sub>-C<sub>2</sub>)</td>
            </tr>
            <tr>
                <td>Gás Liquefeito de Petróleo (GLP)</td>
                <td>< 40</td>
                <td>Composto principalmente por propano e butano (C<sub>3</sub>-C<sub>4</sub>)</td>
            </tr>
            <tr>
                <td>Nafta</td>
                <td>20 a 220</td>
                <td>Composto por C<sub>5</sub>-C<sub>10</sub></td>
            </tr>
            <tr>
                <td>Querosene</td>
                <td>150-300</td>
                <td>Composto por C<sub>10</sub>-C<sub>15</sub></td>
            </tr>
            <tr>
                <td>Gasóleo Atmosférico</td>
                <td>100-400</td>
                <td>Composto por C<sub>13</sub>-C<sub>25<sub></td>
            </tr>
            <tr>
                <td>Gasóleo de Vácuo</td>
                <td>400-570</td>
                <td>Composto por C<sub>25</sub>-C<sub>38</sub></td>
            </tr>
            <tr>
                <td>Resíduo de Vácuo</td>
                <td>> 570</td>
                <td>Composto por >C<sub>38</sub></td>
            </tr>
        </table>
        <caption>Fonte: Thomas, 2004 e Antunes, 2007.</caption>
...
<br><h2 id = "5-5">5.5. Processos de conversão</h2>
...
<br><h2 id = "5-7">5.7. Processos auxiliares</h2>
    <h3>5.7.1. Geração de Hidrogênio</h3>
        <p>Os processos de hidrotratamento e hidrocraqueamento das refinarias de petróleo usam o gás hidrogênio em abundância, e algumas o produzem nas unidades de reforma catalítica. Contudo, a unidade de reforma catalítica não consegue produzir H2 em quantidades suficientes para atender as demandas do HDT e HCC. Por isso, em refinarias possuem unidades de HDT e HCC faz-se necessário a instalação de uma unidade de geração de hidrogênio, operando segundo reações de oxidação parcial das frações pesadas ou de reforma das frações leves com vapor d’água.</p>
        <p>A reforma com vapor é a rota de obtenção de hidrogênio escolhida pela Petrobrás em suas refinarias. Nesta rota os hidrocarbonetos são rearranjados na presença de vapor e catalisadores, gerando o gás de síntese, uma mistura de CO e H2. Mais hidrogênio é posteriormente gerado através da reação do CO com excesso de vapor, após a absorção do CO<sub>2</sub> produzido em monoetanolamina.</p>
    <h3>5.7.2. Recuperação de enxofre</h3>
        <p>A unidade de recuperação de enxofre usa como carga as correntes de gás sulfídrico (H<sub>2</sub>S) geradas no tratamento DEA ou em outras unidades, como o HDT, o HCC, a reforma catalítica e o coqueamento retardado. A recuperação do enxofre se dá pela oxidação parcial do H2S através do processo Clauss, com produção de enxofre elementar. Na unidade de recuperação de enxofre mais de 93% do H<sub>2</sub>S é recuperado como enxofre de alta pureza, superior a 99,8%.</p>

<br><h2 id = "5-8">5.8. Construindo e fixando o conhecimento</h2>
    ...
    <p><span class = "bold">10. </span> O H<sub>2</sub> é produzido na unidade de reforma catalítica e consumido nas unidades de HDT e HCC, então, explicar porque se justifica a instalação de uma unidade geradora de H2?</p>

<br><h2 id = "5-ref">Referências Bibliográficas</h2>
