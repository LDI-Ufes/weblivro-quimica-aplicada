...
<figure class="tabela">
    <table>
        ...
        <tr>
            ...
            <td>
                < 40</td>
            <td>Composto principalmente por metano e etano (\(C_1\)-\(C_2\))</td>
        </tr>
        <tr>
            <td>Gás Liquefeito de Petróleo (GLP)</td>
            <td>
                < 40</td>
            <td>Composto principalmente por propano e butano (\(C_3\)-\(C_4\))</td>
        </tr>
        <tr>
            <td>Nafta</td>
            <td>20 a 220</td>
            <td>Composto por \(C_5\)-\(C_{10}\)</td>
        </tr>
        <tr>
            <td>Querosene</td>
            <td>150-300</td>
            <td>Composto por \(C_{10}\)-\(C_{15}\)</td>
        </tr>
        <tr>
            <td>Gasóleo Atmosférico</td>
            <td>100-400</td>
            <td>Composto por \(C_{13}\)-\(C_{25}\)</td>
        </tr>
        <tr>
            <td>Gasóleo de Vácuo</td>
            <td>400-570</td>
            <td>Composto por \(C_{25}\)-\(C_{38}\)</td>
        </tr>
        <tr>
            <td>Resíduo de Vácuo</td>
            <td>> 570</td>
            <td>Composto por >\(C_{38}\)</td>
        </tr>
    </table>
...
<p>O tratamento utilizando dietanolamina (DEA) é um processo específico para a retirada de \(H_2S\) de frações gasosas do petróleo, principalmente das oriundas de unidades de craqueamento. Este tratamento também retira \(CO_2\) que esteja na corrente gasosa. O processo baseia-se na capacidade de soluções de etanolaminas, mais especificamente a dietanolamina de solubilizar de forma seletiva o \(H_2S\) e o \(CO_2\). Este tratamento é imperativo em unidades de craqueamento catalítico devido ao alto teor de \(H_2S\) do gás combustível produzido. A DEA possui uma grande capacidade de regeneração, e pode ser substituída por MEA (monoetanolamina) em unidades cujas correntes não contenham sulfeto de carbonila \((SCO)\).</p>
...
<p>A reforma com vapor é a rota de obtenção de hidrogênio escolhida pela Petrobrás em suas refinarias. Nesta rota os hidrocarbonetos são rearranjados na presença de vapor e catalisadores, gerando o gás de síntese, uma mistura de \(CO\) e \(H_2\). Mais hidrogênio é posteriormente gerado através da reação do \(CO\) com excesso de vapor, após a absorção do \(CO_2\) produzido em monoetanolamina.</p>
