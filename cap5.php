...
<p>Onde <em>dr</em> (60/60) é a densidade relativa do petróleo medida a 60 F. A classificação do grau API é apresentada na Tabela 5.1.</p>
<!-- TÍTULO TABELA 5.1 -->
<p><span class="boldSecundario">Tabela 5.1.</span> Classificação do grau API para petróleos.</p>

<figure class="tabela">
    <table>
        <tr>
            <th>Petróleo</th>
            <th>Densidade (kg/m<sup>3</sup>)</th>
            <th>Grau API</th>
        </tr>
        <tr>
            <td>Leve</td>
...
<div class="atv">
    ...
    <p>Faça um breve levantamento sobre outras formas de classificação do petróleo. Sugestão: Pesquisar por Grau KUOP, número de acidez total (NAT) e ponto de ebulição verdadeiro (PEV).</p>
</div>
...
<p>Os processos auxiliares têm como objetivo fornecer insumos para possibilitar a operação ou efetuar o tratamento de rejeitos dos outros tipos de processo citados anteriormente. São exemplos de processos auxiliares a geração de hidrogênio (para produzir matéria-prima para as unidades de hidroprocessamento) e a recuperação de enxofre (gerado a partir da combustão de gases ricos em H<sub>2</sub>S). Ressalta-se que insumos de uma refinaria são as utilidades, tais como vapor, água, energia elétrica, ar comprimido, distribuição de gás e óleo combustível, tratamento de efluentes, entre outros. </p>
...
<figure class="tabela">
    <table>
        <tr>
            <th>Corte ou fração</th>
            <th>Temperatura de Corte (°C)</th>
            <th>Hidrocarbonetos</th>
        </tr>
        <tr>
            <td>Gás Combustível</td>
            <td>
                < 40</td>
            <td>Composto principalmente por metano e etano (<span class="nobreak">C<sub>1</sub>—C<sub>2</sub></span>)</td>
        </tr>
        <tr>
            <td>Gás Liquefeito de Petróleo (GLP)</td>
            <td>
                < 40</td>
            <td>Composto principalmente por propano e butano (<span class="nobreak">C<sub>3</sub>—C<sub>4</sub></span>)</td>
        </tr>
        <tr>
            <td>Nafta</td>
            <td>20 a 220</td>
            <td>Composto por <span class="nobreak">C<sub>5</sub>—C<sub>10</sub></span></td>
        </tr>
        <tr>
            <td>Querosene</td>
            <td>150-300</td>
            <td>Composto por <span class="nobreak">C<sub>10</sub>—C<sub>15</sub></span></td>
        </tr>
        <tr>
            <td>Gasóleo Atmosférico</td>
            <td>100-400</td>
            <td>Composto por <span class="nobreak">C<sub>13</sub>—C<sub>25</sub></span></td>
        </tr>
        <tr>
            <td>Gasóleo de Vácuo</td>
            <td>400-570</td>
            <td>Composto por <span class="nobreak">C<sub>25</sub>—C<sub>38</sub></span></td>
        </tr>
        <tr>
            <td>Resíduo de Vácuo</td>
            <td>> 570</td>
            <td>Composto por ><span class="nobreak">C<sub>38</sub></span></td>
        </tr>
    </table>
    <figcaption>Fonte: Thomas, 2004 e Antunes, 2007.</figcaption>
</figure>


<h3>5.4.2. Extração com solvente</h3>
<p>O resíduo de vácuo ainda possui um gasóleo de alta viscosidade que não pode ser obtido por destilação, mas pode ser recuperado usando a extração com solventes. A desasfaltação a propano é feita usando propano líquido a alta pressão como agente de extração. O principal produto é o óleo desasfaltado, que pode ser incorporado ao gasóleo de vácuo na produção de combustíveis, sendo então enviado à unidade de craqueamento catalítico. No caso de se produzir lubrificantes, o óleo desasfaltado constitui um óleo básico <em>Brightstok</em> ou óleo de cilindro, que deve ter sua qualidade melhorada, sendo a viscosidade a propriedade de maior importância. </p>
<p>A desaromatização a furfural é outro processo de extração com solvente realizada na produção de lubrificantes, onde o furfural é usado como solvente de extração de compostos aromáticos polinucleados de alto peso molecular. O objetivo deste processo é aumentar o índice de viscosidade dos óleos lubrificantes, pois quanto maior esse valor, menor será a variação da viscosidade do produto com a temperatura. O produto principal do processo é o óleo desaromatizado. O processo é bastante semelhante à desasfaltação, contendo seções de extração, recuperação de solvente do extrato e recuperação de solvente do refinado.</p>
<p>A desparafinação a MIBC também é uma operação de extração com solvente efetuada na produção de lubrificantes. A presença de parafinas lineares aumenta o ponto de fluidez do lubrificante, dificultando seu escoamento. Essa propriedade é, principalmente, importante quando se utilizam óleos lubrificantes a baixas temperaturas, maior a chance de ocorrer a precipitação das parafinas. As parafinas devem ser extraídas do óleo usando um solvente que proporcione a diluição do óleo enquanto precipita as parafinas, o metilisobutilcetona. O produto final do processo é o óleo desparafinado.</p>
...
<p>Os catalisadores usados no HCC devem apresentar características de craqueamento e hidrogenação. Catalisadores de óxido de níquel-molibdênio <span class="nobreak">(NiO−MoO)</span> ou óxidos de níquel-tungstênio <span class="nobreak">(NiO−WO<sub>3</sub>)</span>, sobre um suporte de sílica-alumina <span class="nobreak">(SiO<sub>2</sub>−Al<sub>2</sub>O<sub>3</sub>)</span> são usados, contudo estes catalisadores são passíveis de envenenamento por compostos heterocíclicos nitrogenados e metais.</p>
<h3>5.5.6. Alquilação catalítica </h3>
<p>O processo de alquilação catalítica consiste na reação de adição de duas moléculas leves para a síntese de uma terceira de massa molar maior, catalisada por um agente de forte caráter ácido. Sendo a ramificação de olefinas leves uma rota usada na obtenção de gasolina de alta octanagem a partir de componentes do GLP, empregando o <span class="nobreak">HF</span> ou o <span class="nobreak">H<sub>2</sub>SO<sub>4</sub></span> como catalisador. O processo envolve o uso de uma isoparafina, geralmente o isobutano, presente no GLP, combinada a olefinas, tais como o propeno, os butenos e pentenos. Obtém-se, assim, uma gasolina sintética usada como combustível de aviação ou gasolina automotiva de alta octanagem.</p>
<p>Alguns parâmetros operacionais afetam a produtividade do processo, tais como: a <span class="bold">relação isobutano / olefinas</span>, que deve ser mantida em um valor alto para evitar a polimerização das olefinas; a<span class="bold"> temperatura de reação</span>, que dependerá do catalisador usado (de 5 °C a 10 °C para o <span class="nobreak">H<sub>2</sub>SO<sub>4</sub></span>, e de 27 °C a 38 °C para o <span class="nobreak">HF</span>); o <span class="bold">tempo de reação</span>, que dependerá do tempo de residência da mistura catalisador/hidrocarbonetos no reator, da relação catalisador/hidrocarbonetos (constante na faixa de 1 a 2) e da eficiência da mistura; a <span class="bold">pressão de trabalho</span>, que influencia o desempenho dos catalisadores, mesmo não sendo uma variável de processo.</p>
...
<p>O tratamento cáustico consiste no uso de solução aquosa de <span class="nobreak">NaOH</span> ou <span class="nobreak">KOH</span> para lavar uma determinada fração de petróleo, eliminando-se compostos ácidos de enxofre, tais como <span class="nobreak">H<sub>2</sub>S</span> e mercaptanas <span class="nobreak">(R−SH)</span> de baixos pesos moleculares. A carga deste tipo de tratamento compõe-se de frações leves: gás combustível, GLP e naftas. Neste tipo de tratamento há um grande consumo de hidróxido o que gera um elevado custo operacional.</p>
<h3>5.6.2. Tratamento merox</h3>
<p>O tratamento Merox também é chamado de tratamento cáustico regenerativo, e possui a vantagem de regenerar a soda cáustica usada no processo, reduzindo substancialmente seu custo operacional. Este tratamento permite a produção de dissulfetos, podendo ser operado como processo de dessulfurização ou adoçamento. Além disso, pode ser usado em frações leves, como o GLP e a nafta e intermediárias, como o querosene e o diesel. O catalisador usado é a ftalocianina de cobalto em leito fixo ou solubilizada na solução de hidróxido, permitindo a retirada das mercaptanas e oxidando-as a dissulfetos.</p>
<h3>5.6.3. Tratamento Bender</h3>
<p>O tratamento Bender é basicamente um processo de adoçamento para redução de corrosividade, desenvolvido com o objetivo de melhorar a qualidade do querosene de aviação e aplicável a frações intermediárias do petróleo. O processo Bender consiste na conversão de mercaptanas corrosivas em dissulfetos menos agressivos, através de oxidação catalítica em leito fixo em meio alcalino, usando como catalisador óxido de chumbo convertido a sulfeto <span class="nobreak">(PbS)</span> na própria unidade. Este processo não converte compostos nitrogenados, e atualmente encontra-se em desuso.</p>
<h3>5.6.4. Tratamento DEA</h3>
<p>O tratamento utilizando dietanolamina (DEA) é um processo específico para a retirada de <span class="nobreak">H<sub>2</sub>S</span> de frações gasosas do petróleo, principalmente das oriundas de unidades de craqueamento. Este tratamento também retira <span class="nobreak">CO<sub>2</sub></span> que esteja na corrente gasosa. O processo baseia-se na capacidade de soluções de etanolaminas, mais especificamente a dietanolamina de solubilizar de forma seletiva o <span class="nobreak">H<sub>2</sub>S</span> e o <span class="nobreak">CO<sub>2</sub></span>. Este tratamento é imperativo em unidades de craqueamento catalítico devido ao alto teor de <span class="nobreak">H<sub>2</sub>S</span> do gás combustível produzido. A DEA possui uma grande capacidade de regeneração, e pode ser substituída por MEA (monoetanolamina) em unidades cujas correntes não contenham sulfeto de carbonila <span class="nobreak">(SCO)</span>.</p>
<h3>5.6.5. Hidrotratamento (HDT)</h3>
<p>O hidrotratamento é a operação de eliminação de contaminantes dos cortes de petróleo através de reações de hidrogenação usando um catalisador. As reações mais características do processo são: <span class="bold">hidrodessulfurização (HDS)</span> – retirada de compostos sulfurados como mercaptanas, sulfetos, dissulfetos, tiofenos e benzotiofenos; <span class="bold">hidrodesnitrogenação (HDN)</span> – retirada de compostos nitrogenados como piridinas, quinoleínas, isoquinoleínas, pirróis, indóis e carbazóis, com liberação de <span class="nobreak">NH<sub>3</sub></span>; <span class="bold">hidrodesoxigenação (HDO)</span> – retirada de compostos oxigenados como fenóis e ácidos carboxílicos, para inibir reações de oxidação posteriores; <span class="bold">hidrodesmetalização (HDM)</span> – retirada de compostos organometálicos, que causam desativação de catalisadores; <span class="bold">hidrodesaromatização</span> – saturação de compostos aromáticos, sob condições suaves de operação; <span class="bold">hidrodesalogenação</span> – retirada de cloretos; <span class="bold">remoção de olefinas</span> – saturação de naftas oriundas de processos de pirólise.</p>
<p>Os catalisadores usados nos processos HDT possuem atividade elevada e vida útil longa, sendo compostos basicamente de óxidos ou sulfetos de <span class="nobreak">Ni</span>, <span class="nobreak">Co</span>, <span class="nobreak">Mo</span>, <span class="nobreak">W</span>, ou <span class="nobreak">Fe</span>. O suporte deste tipo de catalisador normalmente é a alumina, e não pode apresentar característica ácida, visando evitar reações laterais de craqueamento. O HDT é empregado para óleos lubrificantes básicos, mas pode ser usado em todos os demais derivados. As taxas de reação são afetadas principalmente pela pressão parcial de hidrogênio.</p>

<h2 id="5-7">5.7. Processos auxiliares</h2>
<h3>5.7.1. Geração de Hidrogênio</h3>
<p>Os processos de hidrotratamento e hidrocraqueamento das refinarias de petróleo usam o gás hidrogênio em abundância, e algumas o produzem nas unidades de reforma catalítica. Contudo, a unidade de reforma catalítica não consegue produzir <span class="nobreak">H<sub>2</sub></span> em quantidades suficientes para atender as demandas do HDT e HCC. Por isso, em refinarias que possuem unidades de HDT e HCC faz-se necessário a instalação de uma unidade de geração de hidrogênio, operando segundo reações de oxidação parcial das frações pesadas ou de reforma das frações leves com vapor d’água.</p>
<p>A reforma com vapor é a rota de obtenção de hidrogênio escolhida pela Petrobrás em suas refinarias. Nesta rota os hidrocarbonetos são rearranjados na presença de vapor e catalisadores, gerando o gás de síntese, uma mistura de <span class="nobreak">CO</span> e <span class="nobreak">H<sub>2</sub></span>. Mais hidrogênio é posteriormente gerado através da reação do <span class="nobreak">CO</span> com excesso de vapor, após a absorção do <span class="nobreak">CO<sub>2</sub></span> produzido em monoetanolamina.</p>
<h3>5.7.2. Recuperação de enxofre</h3>
<p>A unidade de recuperação de enxofre usa como carga as correntes de gás sulfídrico <span class="nobreak">(H<sub>2</sub>S)</span> geradas no tratamento DEA ou em outras unidades, como o HDT, o HCC, a reforma catalítica e o coqueamento retardado. A recuperação do enxofre se dá pela oxidação parcial do <span class="nobreak">H<sub>2</sub>S</span> através do processo Clauss, com produção de enxofre elementar. Na unidade de recuperação de enxofre mais de 93% do <span class="nobreak">H<sub>2</sub>S</span> é recuperado como enxofre de alta pureza, superior a 99,8%.</p>
...
<p><span class="bold">2. </span> Determine o grau API de um petróleo cuja densidade é 0,9234 g/dm<sup>3</sup>, em seguida, explique como pode ser classificado este petróleo.</p>
<p><span class="bold">3. </span> Com relação à composição de hidrocarbonetos, como pode ser classificado um petróleo que apresenta uma análise de SARA de 38% de saturados, 25% de aromáticos, 20% de resinas e 7% de asfaltenos? Justifique sua resposta.</p>
<p><span class="bold">4. </span> Com relação à composição de hidrocarbonetos, como pode ser classificado um petróleo que apresenta uma análise de SARA de 74% de saturados, 12% de aromáticos, 12% de resinas e 2% de asfaltenos? Justifique sua resposta.</p>
<p><span class="bold">5. </span> Com relação aos tipos de processos, como está dividido o refino do petróleo?</p>
<p><span class="bold">6. </span> Qual a unidade caracteriza uma planta de refino de petróleo? Que frações são retiradas em uma torre de destilação atmosférica a 250 ºC? E a 430 °C?</p>
<p><span class="bold">7. </span> Qual o princípio químico envolvido nos processos de extração por solvente?</p>
<p><span class="bold">8. </span> Cite dois processos de conversão cujo objetivo se a produção de gasolina de alta octanagem.</p>
<p><span class="bold">9. </span> Qual a diferença entre processo de adoçamento e processo de dessulfurização?</p>
<p><span class="bold">10. </span> O H<sub>2</sub> é produzido na unidade de reforma catalítica e consumido nas unidades de HDT e HCC, então, explique por que se justifica a instalação de uma unidade geradora de H<sub>2</sub>?</p>
...
<p>SZKLO, A. e ULLER, V. C. <strong>Fundamentos de Refino de Petróleo.</strong> Ed. Interciência, Rio de Janeiro, RJ, 2008, 285p.</p>
<p>THOMAS, J. E. <strong>Fundamentos de Engenharia do Petróleo.</strong> Ed. Interciência, Rio de Janeiro, RJ, 2004, 271p.</p>
