<?php
$capitulo = "Capítulo 8";
$titulo = "Indústria de Alimentos";
$abertura = "(img/abertura-capX.png)";
include("components/page-header.php");
?>

<h2 id="8.1">8.1. Introdução</h2>
...
<p>A <span class="bold">fase de beneficiamento</span> é a primeira etapa do processamento da matéria-prima e se divide em: colheita (ou abate), transporte, limpeza, classificação e seleção. Durante a colheita a matéria-prima passa por uma série de procedimentos preliminares de acordo com a sua origem e destino, sendo em seguida transportada de forma adequada para a usina de processamento. Já na usina de processamento, a etapa de limpeza pode ser realizada pela remoção física de resíduos, separação das partes não comestíveis e higienização do produto. </p>
<div class="box">
    <p>As partes rejeitadas são empregadas tradicionalmente na preparação de subprodutos.</p>
</div>
<p>A subdivisão por tamanho e granulometria é realizada durante a classificação. Por fim, é realizada uma seleção do produto de acordo com o seu destino e de suas qualidades organolépticas, físicas, químicas e microbiológicas.</p>
<p>A <span class="bold">fase de elaboração</span> é a etapa de maior importância no processamento de alimentos, pois nela se desenvolvem diversas operações de natureza física, química e biológica que caracterizam os produtos. </p>
<p>A partir do processamento tecnológico de alimentos básicos, tais como o leite, carne, pescado, ovos, frutas e vegetais é possível obter uma variedade maior de produtos. Os principais processos tecnológicos usados na fase de elaboração são:</p>
<ul>
    <li><span class="bold">Processos físicos:</span> moagem, trituração, esmagamento ou prensagem e aplicação de calor;</li>
    <li><span class="bold">Processos químicos: </span> extração por solvente, acidificação, aditivação e salga;</li>
    <li><span class="bold">Processos físico-químicos: </span>refinação, hidrolização, dissolução, emulsificação, caramelização e cristalização;</li>
    <li><span class="bold">Processos biológicos: </span>fermentação e maturação.</li>
</ul>
...
<p>A <span class="bold">fase de preservação e/ou conservação</span> tem início no transcorrer final da fase de elaboração. Esse cuidado é necessário para evitar a contaminação do produto, que deve ser acondicionado, como veremos a seguir, de forma e em condições adequadas, para garantir um maior tempo de vida útil do produto final. Os processos usados nessa etapa visam, especialmente, à eliminação da flora microbiana normal inconveniente e da patogênica, assim como das enzimas produtoras de alterações. Os tipos de tratamento existentes são:</p>
<p><span class="bold">1. Conservação pelo calor:</span> baseia-se no emprego de temperaturas ligeiramente acima das temperaturas máximas que permitem a multiplicação dos microrganismos, de forma a provocar a sua morte ou a inativação de suas células vegetativas. Os principais métodos de conservação por calor são: pasteurização, esterilização, tindalização e apertização.</p>
<p>A pasteurização é um tratamento térmico relativamente suave que emprega temperaturas inferiores a 100 ºC. Ela tem como principal objetivo prolongar a vida de prateleira dos alimentos, por alguns dias, como no caso do leite ou por alguns meses, como ocorre com as frutas enlatadas. Este método tem como princípio, a inativação de enzimas e a destruição dos microorganismos sensíveis a temperaturas mais elevadas, como as bactérias vegetativas, bolores e leveduras, sem, contudo, modificar significativamente o valor nutritivo e as características organolépticas do alimento submetido a esse tratamento. </p>
...
<figure>
    ...
    <figcaption><span class="bold">Figura 8.3. </span>Sistema de purificação UHT para sucos de frutas, leite e outras bebidas semelhantes. Fonte: <a href="https://www.alibaba.com/product-detail/Tubular-Pasteurized-Tubular-UHT-Milk-Pasteurized_1600339333795.html?spm=a2700.galleryofferlist.normal_offer.d_title.12d216d0mrPfG5&s=p" target="_blank" rel="noopener noreferrer">Alibaba.com</a></figcaption>
</figure>
...
<p>Diferente dos demais, na tindalização o aquecimento é feito de maneira descontínua. Após o acondicionamento das matérias-primas alimentícias, a serem submetidas ao tratamento, em recipiente fechado, o produto é submetido ao tratamento térmico. Dependendo de cada produto e do rigor térmico desejado, as temperaturas variam de 60 a 90 °C, durante alguns minutos. As células bacterianas que se encontram na forma vegetativa são destruídas, porém os esporos sobrevivem. Depois do resfriamento, os esporos entram em processo de germinação e depois de 24 horas a operação é repetida. O número de operações pode variar de 3 a 12 vezes até a obtenção da esterilização completa. A vantagem desse processo é que podem ser mantidos praticamente todos os nutrientes e as qualidades organolépticas do produto, em proporções maiores do que quando se utilizam outros tratamentos térmicos.</p>
<p>Por fim, a apertização é a aplicação do processo térmico a um alimento convenientemente acondicionado em uma embalagem hermética, resistente ao calor, a uma temperatura e um período de tempo cientificamente determinados, para atingir a esterilização comercial. Este processo corresponde ao aquecimento do produto já elaborado, envasado em latas, vidros, plásticos ou outros materiais e relativamente isentos de ar.</p>
<p><span class="bold">2. Conservação pelo frio:</span> diferentemente da conservação pelo calor, a conservação pelo frio emprega temperaturas abaixo da temperatura ambiente para retardar as reações químicas e as atividades enzimáticas, bem como para retardar ou inibir o crescimento e a atividade dos microrganismos nos alimentos. Pode ser dar por refrigeração ou congelamento.</p>
<p><span class="bold">3. Conservação pelo controle da umidade:</span> geralmente, ambientes que apresentam ausência de água ou são desidratados apresentam uma redução da atividade enzimática e microbiana, uma vez que sua proliferação é minimizada. As principais técnicas usadas são: secagem natural, desidratação ou secagem artificial. </p>
<p><span class="bold">4. Conservação pela adição de um soluto:</span> a adição elevada de quantidades de açúcar ou sal ao alimento pode reter quantidades variadas de água, o que resulta em um estado qualificado de controle da pressão osmótica. A preservação de frutas pela adição de açúcar, transformando-as em geleias, doces em massa e outros produtos similares ocorre pela elevada concentração de açúcar. Estes produtos contêm em média de 25 a 33% de umidade, mas podem ser conservados sem maiores problemas. O sal também é bastante eficaz na preservação de carnes e peixes.</p>
<p><span class="bold">5. Conservação por defumação: </span>consiste no processo de aplicação de fumaça aos produtos alimentícios, produzida pela combustão incompleta de algumas madeiras previamente selecionadas. Normalmente é realizado em conjunto com a salga, a cura, a fermentação e outros processos. Em carnes, o contato com o calor e a fumaça provoca a perda da água, gerando uma superfície ressecada e de coloração estabilizada. A perda de água e a ação dos constituintes da fumaça conferem ao alimento barreiras físicas e químicas eficientes contra a penetração e a atividade de micro-organismos. Essa capa protetora pode ser devido à desidratação que se processa na superfície do produto (principalmente na defumação a quente), à coagulação proteica que ocorre durante a defumação e ao depósito das substâncias antimicrobianas que existem na fumaça, que se condensam e ficam depositadas na superfície do produto. </p>
<p><span class="bold">6. Conservação por fermentação:</span>emprega o crescimento controlado de microrganismos selecionados, capazes de modificar sua textura, sabor e aroma, como também suas propriedades nutricionais.</p>
...
<p>O processamento do leite tem início após a ordenha. Na primeira etapa, o leite é armazenado num aparelho de refrigeração a uma temperatura entre 0 e 4 °C, portanto ela é conhecida como etapa de arrefecimento. Posteriormente, ele é recolhido por um caminhão cisterna com sistema de refrigeração de mesma temperatura. </p>
<p>A matéria-prima é recebida nas fábricas onde são imediatamente recolhidas amostras do leite cru para a realização de análises físico-químicas e microbiológicas. Em seguida, conforme a acidez e outras características organolépticas, o leite é separado. Só então, o leite passa por outra etapa de arrefecimento que pode ir dos 4 °C a 2 °C, num permutador de placas, e é armazenado por um período máximo de 24 horas. </p>
<p>Após a recepção, o leite segue para a termização, que consiste em um tratamento térmico de menor intensidade do que a pasteurização, usualmente empregando temperaturas entre 60 e 69 °C por 15-20 segundos, evitando o crescimento de contaminantes psicotróficos (<em>Pseudomonas</em> s.p), e a formação de lipases e proteinases termo resistentes. </p>
<p>No processo seguinte de desnatação, é retirado o máximo de gordura do leite através de uma desnatadeira. Este processamento torna-se mais eficaz a temperaturas mais elevadas em virtude da menor viscosidade do leite. Segue-se a normalização que tem como objetivo o ajuste e a estabilização do teor de gordura no leite.</p>
<div class="box">
    <p>De acordo com o teor de gordura o leite pode ser classificando como gordo (3,5% de teor de gordura), meio gordo (1,5% de teor de gordura) e magro (vestígios de gordura).</p>
</div>
<p>Na homogeneização o leite passa por um processo de distribuição uniforme da gordura para evitar a formação de nata. Este processo melhora a estabilidade e consistência do leite. Depois ocorre a pasteurização via processo UHT, realizada a altas temperaturas (130 °C, entre 2 e 4 segundos) para assegurando a destruição completa de bactérias resistentes ao calor, formadoras de esporos (bacilos de Cock), tornado o leite estéril. Este processo inclui um rápido resfriamento para minimizar qualquer dano ao produto.</p>
<p>Por fim, segue-se a etapa de enchimento asséptico, armazenagem à temperatura ambiente e a expedição do produto final para os vários postos de venda.</p>
<div class="box">
...
<p>A industrialização das sementes de soja divide-se em duas partes principais: produção do óleo bruto e refino.</p>
<h4>I. Produção do óleo bruto</h4>
<p>A produção de óleo bruto se inicia com o armazenamento das sementes e depende diretamente do fator umidade, já que os grãos têm a propriedade de absorver e ceder água para a atmosfera que os envolve. Essa troca de água tende a gerar um equilíbrio onde a tensão de vapor de água dentro do grão nivela-se à pressão de água contida no ar. </p>
<div class="box">
    <p>Tal equilíbrio é chamado de equilíbrio higroscópico. </p>
</div>
<p>As condições que levam a uma intensa atividade respiratória da semente são igualmente favoráveis ao crescimento das bactérias e mofos, ocasionando a deterioração dos grãos armazenados. Portanto, as sementes são melhores armazenadas com baixa umidade, onde o crescimento do mofo e de outros eventuais danos as sementes serão minimizados.</p>
<p>Os grãos de soja colhidos nos campos são transportados via rodovia ou ferrovia até as fábricas. Na fábrica são realizados os primeiros controles para a armazenagem destes grãos, como o teor de umidade, quantidade de material estranho e incidência de grãos “danificados”. Realiza-se também a pré-limpeza, que nada mais é do que a retirada de impurezas mais grossas (galhos, meio grãos, etc.) antes do armazenamento. Essa etapa é realizada em máquinas especiais dotadas de peneiras vibratórias e visa diminuir o risco de deterioração e maximizar o espaço útil do silo. </p>
<p>Em seguida, o grão é preparado para extração via uma limpeza, para eliminação de impurezas vegetais, minerais e metálicas, mediante peneiramento, aspiração e separação magnética. Ele passa também por uma etapa de ruptura, para reduzir os grãos em pedaços de 1/4 a 1/6 do tamanho do grão inteiro.</p>
<p>Quando se deseja produzir um farelo com alto conteúdo proteico, realiza-se a etapa de descascamento, seguido do sistema de separação das cascas. Já que os grãos de soja estão recobertos em média com 8% de cascas e a operação de descascamento traz a vantagem do aumento do conteúdo proteico de 44% para 48%. </p>
<p>Posteriormente, os grãos passam por um condicionamento térmico por meio de aquecimento a 65 °C em condicionadores do tipo vertical ou, mais comumente, do tipo horizontal. Depois, os grãos passam por um processo de laminação para facilitar o rompimento do tecido e das paredes das células, diminui a distância entre o centro da célula e a superfície, aumentando a superfície de saída de óleo. Obtêm-se, desta forma, flocos com 0,2 a 0,4 mm de espessura por um diâmetro equivalente de 10 a 30 mm.</p>
<p>Só então esse material passa por um cozimento para promover o rompimento das paredes das células e facilitar a saída do óleo. O cozimento ocorre em um aparelho chamado “chaleira” que é composto por 4 ou 5 bandejas sobrepostas, aquecidas a vapor direto ou indireto. Durante essa etapa, eleva-se a temperatura dos flocos laminados e se aumenta a umidade do sistema. Com o aumento da umidade dos flocos e o rompimento das paredes da célula, se consegue facilitar a saída do óleo. Nas bandejas superiores as sementes são submetidas ao vapor direto e indireto, já na última bandeja ocorre à secagem dos grãos.</p>
<p>Por fim, tem-se a extração do óleo bruto, que pode ser feita por prensagem mecânica e/ou com a utilização de solventes. </p>
<p>A prensagem mecânica é efetuada modernamente por prensas contínuas, que são usadas para uma remoção parcial do óleo, seguida por extração com o solvente, constituindo o processo misto. A prensagem mecânica é realizada sob alta pressão reduzindo o conteúdo de óleo na torta em até 5%. </p>
<p>Já na extração por solvente, a obtenção da matéria oleosa é feita por meio de um solvente proveniente da mistura de hidrocarbonetos (hexano) com uma fração de petróleo, com ponto de ebulição de 70 °C. Para facilitar a penetração do solvente no interior das sementes, o material a ser extraído é triturado e laminado. </p>
<h4>II. Refino</h4>
<p>Para ser usado em larga escala pela indústria alimentícia, o óleo bruto de soja tem que passar pelo processo de refinação. O processo de refinação tem como finalidade melhorar a aparência, odor e sabor do óleo, o que ocorre devido à remoção de:</p>
<ul>
    <li> Substâncias coloidais, proteínas fosfatídeos e produtos de sua decomposição; </li>
    <li> Ácidos graxos livres e seus sais, ácidos graxos oxidados, lactonas, acetais e polímeros;</li>
    <li> Corantes, tais como clorofila, xantofila, carotenoides; </li>
    <li> Substâncias voláteis, tais como hidrocarbonetos, alcoóis, aldeídos, cetonas e ésteres de baixo peso molecular;</li>
    <li> Substâncias inorgânicas, tais como: sais de cálcio e de outros metais, silicatos, fosfatos e outros;</li>
    <li> Umidade.</li>
</ul>
...
<p>BEHMER, M. L. A. <strong>Tecnologia do leite: leite, queijo, manteiga, caseína, iogurte, sorvetes e instalações: produção, industrialização, análise.</strong> 15a edição, Ed. Nobel, São Paulo, 1991. 320p.</p>
<p>MORETTO, E.; ALVES, R. F. <strong>Óleos e gorduras vegetais: (processamento e analises).</strong> 1a edição Ed. da UFSC, Florianópolis, 1986. 179p. </p>
