...
<h2 id = "2-1">2.1. Uma breve introdução sobre a indústria do cloro e da soda cáustica</h2>
  ...
  <table>
    ...
    <tr>
      <td>Brasil - Trikem – (AL)</td>
      <td>32 (média)</td>
    </tr>
    <tr>
      <td>Brasil - Carbocloro – (SP) </td>
      <td>40 (média)</td>
    </tr>
    <tr>
      <td>Índia </td>
  ...
  <caption>Fonte: C&EN, Empresas, CMAI, ECN. </caption>
  ...
  <p>O cloro e a soda cáustica desempenham um papel importante e significativo na fabricação de milhares de produtos dos quais nós dependemos no nosso dia a dia. A Figura 2.3 mostra um fluxograma representativo do processo envolvido na fabricação e consumo dos produtos obtidos durante a eletrólise da salmoura e a partir desses produtos (Cl<sub>2</sub> e NaOH) é possível utilizar essa matéria-prima na produção de outros insumos em diversos segmentos da indústria.</p>
  ...
  <table>
    <tr>
      <th>Cloro-capacidade instalada/2010</th>
      <th>Estado</th>
  ...
  <caption>Nota: D – diafragma; M – membrana; Hg – Mercúrio <br> Fonte: Abiclor </caption>
  ...
  <div class = "box"><p>Em 1774, Karl Wilhelm Scheele descobriu a substância Cloro, Cl<sub>2</sub>. Esta substância é encontrada na temperatura ambiente no estado físico gasoso, sendo um gás extremamente tóxico e de odor irritante. Um das suas característica interessante está no fato dele ser duas vezes e meia mais pesado do que o ar atmosférico.<p></div>


<br><h2 id = "2-2">2.2. Fabricação do cloro e da soda cáustica</h2>
  <h3>Célula de Diafragma</h3>
    ...
    <div class = "box">
      <p><strong>Ânodo:</strong> 2Cl<sup>-</sup>(aq) → Cl<sub>2</sub>(g) + 2e<sup>-</sup></p>
    ...
    <figure>
      ...
      <figcaption><span class = "bold">Figura 2.5. </span>Representação esquemática do processo de fabricação de Cloro e hidróxido de sódio a partir da eletrólise da salmoura (solução salina – H<sub>2</sub>O + NaCl)</figcaption>
    </figure>
    ...
    <p>O processo de produção industrial consiste de:</p>
    <ul class = "indentacao">
      <li> Unidade de tratamento da salmoura; </li>
      <li> Sala de eletrólise;</li>
      <li> Unidade de evaporação;</li>
      <li> Sistemas de processamento do gás (Cl<sub>2</sub> e H</sub>2); </li>
    ...
    <div class = "box">
      <p>O cloro úmido não deve ser operado em tubulação feita em ferro ou aço, pois ele pode atacar esses metais. Por isso, nessa fase do processo o ideal é trabalhar com materiais mais resistentes, tais como: poliéster ou PVC (cloreto de polivinilo).</p>
    </div>
    <!-- FIGURA 2.6 -->
    <figure>
  ...
  <h3>Célula de Mercúrio</h3>
    ...
    <p>A salmoura (NaCl + H2O) entra na extremidade superior e entra em contado com o ânodo, o qual pela aplicação de uma diferença de potencial, eletrolisa os íons cloretos produzindo o gás cloro, que flui a partir da porção superior da calha e então sai. Os íons de sódio presentes em solução migram para o cátodo e reagem com o mercúrio para formar amálgama de sódio (uma liga de mercúrio e de sódio), que flui para fora da célula pela extremidade inferior dentro de um tanque cilíndrico vertical. Entre 0,25% a 0,5% de amálgama de sódio é produzida na célula. As seguintes reações químicas para o processo são:</p>
    ...
    <p>Em casos especiais, em virtude da solicitação de hidrogênio quase puro contendo pequenas quantidades de oxigênio, algumas plantas podem aquecer o hidrogênio sobre um catalisador de platina (para remover o oxigênio por reação com o hidrogênio para formar água), e assim, obter um gás hidrogênio altamente puro.</p>
    <figure class = "lateral"><img src = "img/mercurio.jpg"></figure>
  ...
  <h3>A célula de membrana</h3>
    ...
    <p>Soda cáustica diluída (32%) é introduzida no compartimento catódico, onde os íons de sódio reagem com os íons hidroxilas, produzidos durante a reação de formação e desprendimento de gás hidrogênio pela redução das moléculas de água. Assim, a concentração da solução inicial de soda cáustica a 32% fica mais concentrada em virtude da formação de mais moléculas de hidróxido de sódio (soda cáustica), ou seja, concentração da solução de soda cáustica passa a ser de aproximadamente 35%. O gás hidrogênio umidificado sai do compartimento catódico pela parte superior. Uma parte do produto de soda cáustica é retirada do compartimento catódico e vai para o sistema de evaporação e outra parte é diluída para 32% e retorna para o compartimento catódico.</p>
    ...
    <table>
      ...
      <tr>
        <th>Voltagem da célula (Volts)</th>
        <td>2,9 – 3,5</td>
        <td>3,0 – 3,6</td>
        <td>3,9 – 4,2</td>
      </tr>
      ...
      <tr>
        <th>Consumo de energia (kWh/MT* de Cl<sub>2</sub>) <em>[Densidade de corrente de (kA/m2)]</em></th>
        <td>2720<em>[1,7]</em></td>
        <td>2650<em>[5,0]</em></td>
        <td>3360<em>[10,0]</em></td>
      </tr>
      <tr>
        <th>Consumo de vapor (kWh/MT* de Cl<sub>2</sub>) para concentração de 50% NaOH</th>
        <td>610</td>
        <td>180</td>
        <td>0</td>
      </tr>
    </table>
    <caption>*MT - Tonelada métrica = 1000 kg = 2205 lbs. Fonte: Ref. [ELETROCHEM].</caption>
    

    
  <h3>Tipos de eletrodos usados</h3>
    <p>Durante os anos 1900, o ânodo utilizado para a geração de cloro era a platina ou a magnetita. No entanto, por causa do elevado custo da platina e de a densidade de corrente limitação (0,4 kA/m2) com a magnetita, o grafite se tornou predominantemente o material utilizado como ânodo desde 1913 a meados dos anos 1970. Em 1919, Acheson desenvolveu os ânodos de grafite artificiais, que posteriormente foram modificados por Wheeler, que os impregnou com óleo de linhaça melhorando o seu desempenho eletroquímico.</p>
    ...
    <p>A história dos eletrodos conhecidos como ânodos dimensionalmente estáveis, se funde com a importância da utilização do RuO2 como material eletroativo que recobre a superfície do eletrodo. Os trabalhos que relatam essa história podem ser verificados numa série de artigos produzidos por Trasatti e Hayfield. A primeira patente dos ADE® apareceu em 1965 e uma segunda em 1967 que foram propostas por Henri Bernard Beer que revolucionarão a indústria de cloro-álcali.</p>
    <p>Nestas patentes, Beer descreve o método de preparação dos eletrodos pela técnica de decomposição térmica de precursores de cloretos sobre um substrato de titânio, o qual ficava revestido com os óxidos do grupo da platina ou óxidos metálicos não nobres tais como: TiO<sub>2</sub>, SnO<sub>2</sub>, etc. Estes ânodos foram inicialmente usado em células de mercúrio da Denora, e eles exibiram baixa tensão da célula e uma vida longa.</p>
  ...
  <br><h2 id = "2-3">2.3. Teste para garantir a qualidade de produto</h2>
  ...
  <p><span class = "boldSecundario">Tabela 2.4.</span> Determinações e metodologia usadas na verificação da qualidade dos produtos Cloro e Hipoclorito de sódio.</p>
  <!-- TABELA 2.4 -->
  <table>
    <tr>
      <th>Determinações</th>
    ...
    <tr>
      <td>Ferro</td>
      <td>Espectrofotométrico visível*</td>
    </tr>
    <tr>
      <td>Cloro ativo</td>
    ...
    <tr>
      <td>Teor de clorato</td>
    </tr>
    <tr>
      <td>Taxa de geração de gases</td>
      <td>Gasométrico </td>
    </tr>
    <tr>
      <td>Alcalinidade de hidróxido e carbonato</td>
      <td>Potenciométrico/Volumétrico</td>
    </tr>
    <tr>
      <td>Materiais insolúveis </td>
      <td>Filtração à vácuo constante</td>
    </tr>
  </table>
  <caption>*Método 1 – Ortofenantrolina; Método 2 – Tiocianato de potássio. Fonte: Abiquim; ABNT.</caption>

  <!-- TITULO DA TABELA 2.5 -->
  <br><br><p><span class = "boldSecundario">Tabela 2.5.</span> Determinações e metodologia usadas na verificação da qualidade do produto Soda cáustica.</p>
  <!-- TABELA 2.5 -->
  <table>
    <tr>
      <th>Determinações</th>
    ...
    <tr>
      <td>Carbonato</td>
      <td>Potenciométrico e Volumétrico*</td>
    </tr>
    <tr>
      <td>Teor de clorato</td>
      <td rowspan = "2">Volumétrico</td>
    ...
    <tr>
      <td>Taxa de sulfato (Na<sub>2</sub>SO<sub>4</sub> < 0,05 % /massa)</td>
    </tr>
    <tr>
      <td>Alcalinidade total (% NaOH e Na<sub>2</sub>O)</td>
      <td>Espectrofotométrico/Volumétrico</td>
    </tr>
    <tr>
      <td>Mercúrio (0,05 até 10 mg/kg)</td>
      <td>Absorção Atômica por Chama</td>
    </tr>
    <tr>
      <td>Sílica (SiO<sub>2</sub> < 10 mg/kg)</td>
      <td>Espectrofotométrico visível com molibdato de amônio</td>
    </tr>
  </table>
  <caption>*Titulação com solução padronizada de HCl. Fonte: Abiquim; ABNT.</caption>
  

  <br><br><br><div class = "atv">
    <h3>Atividade 2.1</h3>
    <p>Uma das etapas do processo industrial utilizado para a fabricação de cloro e soda cáustica é a eletrólise de uma solução de salmoura (NaCl + H<sub>2</sub>O). Durante o processo eletrolítico os íons cloretos são convertidos em Cl<sub>2</sub> no compartimento anódico e no compartimento cátodo é gerado hidróxido de sódio e gás hidrogênio. <br><br> Escrever as equações químicas envolvidas no processo usando células de membranas. Quantos mols de cloro são gerados no ânodo durante a eletrólise da salmoura com uma corrente de 4,00 A por um período de 2 horas? <br><br>Dados: Constante de Faraday = 96500 C/mol; 1 A = 1 C/s. </p>
  </div>


<br><h2 id = "2-4">2.4. Construindo e fixando o conhecimento</h2>
...
<br><h2 id = "2-ref">Referências Bibliográficas</h2>
<!-- TEM REFERENCIA INCOMPLETA -->
  ...
  <p>WONGTSCHOWSKI, P. <strong>Indústria Química</strong> – riscos e oportunidades, 2ª. Edição revista e ampliada; Edgard Blücher LTDA; São Paulo, SP, 2002.</p>
  <p>ULLMANN´S.<strong> Encyclopedia of industrial chemistry.</strong> VCH, New York, NY, 1987.</p>
  <p>ABICLOR. <strong>Relatório Anual da indústria Brasileira de Álcalis, Cloro e derivados.</strong> </p>
  <p><a class = "ref" alt = "Abrir site em nova aba" target = "_blank" href = "http://www.abiquim.org.br">http://www.abiquim.org.br</a></p>
  <p><a class = "ref" alt = "Abrir site em nova aba" target = "_blank" href = "http://electrochem.cwru.edu/encycl/art-b01-brine.htm">http://electrochem.cwru.edu/encycl/art-b01-brine.htm</a></p>
  <p>BOMMARAJU, T. V.; OROSZ, P. J.; SOKOL, E. A. <strong>Brine Electrolysis</strong>. Process Technology Optimization, Inc. New York, NY, 2007.</p>
  <p>TRASATTI, S. <strong>Electrocatalysis:</strong> Understanding the Success of DSA. Electrochim. Acta 2000, 45, 2377-2385.</p>
  <p>TRASATTI, S. <strong>Physical Electrochemistry of Ceramic Oxides. Electrochim.</strong> Acta 1991, 36, 225-241. </p>
  <p>HAYFIELD, P. C. S. <strong>Development of the Noble Metal/Oxide Coated Titanium Electrode.</strong> Part I: The Beginning of the Story.  Platin. Met. Rev. 1998, 42, 27-33. </p>
  <p>HAYFIELD, P. C. S. <strong>Development of the Noble Metal/Oxide Coated Titanium Electrode.</strong> Part II: The Move to Platinum/Iridium to Ruthenium Oxide Electrocatalyst. Platin. Met. Rev. 1998, 42, 46-55.</p>
  <p>HAYFIELD, P. C. S. <strong>Development of the Noble Metal/Oxide Coated Titanium Electrode.</strong> Part III: Coated Titanium Anodes in Widely Ranging Oxygen Evolving Situations. Platin. Met. Rev. 1998, 42, 116-122.</p>
  <p>BEER, H. B.<strong>British Patent 1,147,442;</strong> 1965</p>
  <p>BEER, H. B. <strong>Electrode for Use in Electrolytic Process<strong>. British Patent, 1,195,871, 1967.</p>
  <p><a class = "ref" alt = "Abrir site em nova aba" target = "_blank" href = "http://www.denora.com.br">http://www.denora.com.br</a></p>
  <p>ABNT. <strong>Associação Brasileira de Normas Técnicas.</strong></p>
  <p>O'BRIEN, T. F.; BOMMARAJU, T. V., HINE, F. <strong>Handbook of Chlor-Alkali Technology</strong>. Springer, New York, NY, 2005. </p>
