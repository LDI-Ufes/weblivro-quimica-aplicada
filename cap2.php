...
<div class="box">
  <div class="formula longa">
    <div class="line">
      <p><strong>Ânodo:</strong> 2Cl<sup>−</sup>(g) → Cl<sub>2</sub>(aq) + 2e<sup>−</sup></p>
...
<div class="box">
  <div class="formula">
    <div class="line">
      <p>2Na<sup>+</sup>(aq) + Hg + 2e<sup>−</sup> → 2Na(Hg)</p>
...
<p>Soda cáustica diluída (32%) é introduzida no compartimento catódico, onde os íons de sódio reagem com os íons hidróxido, produzidos durante a reação de formação e desprendimento de gás hidrogênio pela redução das moléculas de água. Assim, a concentração da solução inicial de soda cáustica a 32% fica mais concentrada em virtude da formação de mais moléculas de hidróxido de sódio (soda cáustica), ou seja, concentração da solução de soda cáustica passa a ser de aproximadamente 35%. O gás hidrogênio umidificado sai do compartimento catódico pela parte superior. Uma parte do produto de soda cáustica é retirada do compartimento catódico e vai para o sistema de evaporação e outra parte é diluída para 32% e retorna para o compartimento catódico.</p>
...
<figure class="tabela">
  <table>
    ...
    <tr>
      <th>Consumo de energia (kWh/MT* de <span class="nobreak">Cl<sub>2</sub></span>)[Densidade de corrente de <span class="nobreak">(kA/m<sup>2</sup>)</span>]</th>
  ...
  <figcaption>*MT - Tonelada métrica = 1000 kg = 2205 lbs. Fonte: Ref. [ELETROCHEM].</figcaption>
</figure>
...
<figure class="tabela">
  ...
  <figcaption>*Método 1 – Ortofenantrolina; Método 2 – Tiocianato de potássio. Fonte: Abiquim; ABNT.</figcaption>
</figure>
...
<p><span class="bold">5.</span> Descreva quais são os materiais que revestem os eletrodos que são colocados no compartimento anódico em uma célula de diafragma? Qual é a função deste material durante a eletrólise da salmoura?</p>
